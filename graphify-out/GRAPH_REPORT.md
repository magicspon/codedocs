...
## Corpus Check
- 540 files · ~3,900,514 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5429 nodes · 15387 edges · 219 communities (186 shown, 33 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 1400 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3901aeb4`
...
Cohesion: 0.06
Nodes (65): toRepoPath(), SymbolId, DescriptorClass, callerOf(), collectCallSites(), record(), resolveBatch(), resolveSite() (+57 more)

### Community 1 - "Document Claims & Verdicts"
Cohesion: 0.03
Nodes (151): remediationFor(), Candidate, discoverDocuments(), CheckContext, applyScope(), DEFAULT_SCOPE, Scope, Scoping (+143 more)
...
Cohesion: 0.07
Nodes (50): misplacedConfig(), ClassifyRule, DEFAULT_CONFIG, Discover, Remediation, DEFAULTS, effective(), EffectiveLabels (+42 more)

### Community 4 - "CLI Render Notes"
Cohesion: 0.01
Nodes (165): #_(), absarc(), absellipse(), _activateAction(), _addInactiveAction(), _addInactiveBinding(), adoptCameraSettings(), applyConfig() (+157 more)
...
Cohesion: 0.04
Nodes (167): A(), apply(), as(), Ax(), b(), bounds(), bs(), bx() (+159 more)

### Community 8 - "CLI Draft & Stack Traces"
Cohesion: 0.06
Nodes (108): addEventListener(), addGroup(), an(), ap(), Ar(), autoReset(), bm(), bn() (+100 more)

### Community 9 - "Cold-Start Project Indexing"
Cohesion: 0.05
Nodes (98): add(), addLayerUpdate(), addTo(), al(), Au(), axisIntent(), axisThreshold(), bind() (+90 more)
...
Cohesion: 0.06
Nodes (97): aa(), ac(), Ai(), am(), ao(), ba(), bc(), be() (+89 more)

### Community 12 - "Core Test Fixtures & Symbols"
Cohesion: 0.05
Nodes (69): dispatch(), documented(), edges(), subjectOf(), ambiguityNote(), ambiguityNoteFor(), annotate(), baselineChoiceNote() (+61 more)
...
Cohesion: 0.03
Nodes (81): aD(), addInstance(), addPass(), bindMethods(), blitDepthBuffer(), ceil(), cloneMaterial(), computeBoneTexture() (+73 more)

### Community 17 - "Docs Draft Facts Assembly"
Cohesion: 0.06
Nodes (54): excludedBy(), UNSCOPED, labelClaim(), resolveSubject(), extend(), filesOf(), finish(), PathTerminus (+46 more)
...
Cohesion: 0.05
Nodes (72): Commit, FallowMeta, FileDatum, detailFile(), frameSummary, hoveredFile(), rowAt(), cursorFile() (+64 more)

### Community 27 - "Bench Writeup Comparisons"
Cohesion: 0.05
Nodes (68): addObserver(), ag(), array(), attach(), av(), baseHeight(), baseWidth(), bh() (+60 more)

### Community 28 - "Bench Judge Grading"
Cohesion: 0.09
Nodes (32): symbolCount(), everHot(), smogPerFrame(), WEIGHTS, cityLayout, LAMP, lampOf(), litOf() (+24 more)

### Community 29 - "Preflight & Fidelity Concepts (CONTEXT/ADR)"
Cohesion: 0.07
Nodes (45): Changeset: first published release, First published release of @codedocs/cli, Nine edge kinds, closed enum, Three bindings, one to one with the operation set, Arm (toolset@model), baseline arm, codedocs arm, codedocs (+37 more)
...
Cohesion: 0.08
Nodes (29): designation(), Sky, Starfield(), DATASETS, embedded(), Load, loaders, loadNames() (+21 more)
...
Cohesion: 0.07
Nodes (67): loadConfig(), Config, Endpoint, LabelPass, EvidenceAssembly, fidelityOf(), preflightProjects(), ProjectPreflight (+59 more)
...
Cohesion: 0.11
Nodes (29): random(), randomDirection(), sD(), hueOf(), COOL, discStar, HOT, Tilt (+21 more)
...
Cohesion: 0.11
Nodes (45): group(), CallEdge, FileNode, ImportEdge, ProjectNode, ReferenceEdge, SpecifierSite, SymbolNode (+37 more)
...
Cohesion: 0.05
Nodes (58): ah(), az(), bK(), bq(), Cg(), Dg(), dq(), Eg() (+50 more)
...
Cohesion: 0.10
Nodes (40): subjectsOf(), resolvePath(), openFor(), reanalyse(), repairWave(), runWave(), seedFrontier(), touchedProjects() (+32 more)
...
Cohesion: 0.09
Nodes (24): Difficulty levels, Level 1 — local, Level 2 — one subsystem, no address, Level 3 — across layers, Level 4 — a relationship, not a location, Lines changed is not a difficulty signal, The current cases, The levels (+16 more)

### Community 59 - "ADR/CONTEXT: SymbolId Types"
Cohesion: 0.05
Nodes (58): appendChildToContainer(), build(), canRun(), continue(), createMaterialFromType(), defaultMutationOptions(), defaultQueryOptions(), DW() (+50 more)

### Community 60 - "ADR/CONTEXT: Label Axes"
Cohesion: 0.08
Nodes (46): Consequences, Considered Options, Preconditions lower fidelity; honesty is evidence, not a score, Five node types, SCIP symbol string in a codedocs scheme, Two orthogonal classification axes, Discard the index on a version mismatch, never migrate, node:sqlite as the index store (+38 more)
...
Cohesion: 0.11
Nodes (49): af(), at(), Bd(), bf(), cf(), Ci(), ct(), df() (+41 more)

### Community 66 - "Bench Judgements: Chat Widgets Case"
Cohesion: 0.22
Nodes (14): Three channels of honesty that must not blur, #329610 (VS Code chatAttachmentWidgets.ts), #333230 (VS Code listView.ts), ensureContextKeyService (chatAttachmentWidgets.ts), setResourceContext (chatAttachmentWidgets.ts), getVisibleRange (listView.ts), probeDynamicHeights (listView.ts), discarded run (+6 more)

### Community 67 - "Community 67"
Cohesion: 0.13
Nodes (48): abort(), _allocateTargets(), _applyGGXFilter(), _applyPMREM(), _blur(), _blurPass(), Br(), _cleanup() (+40 more)

### Community 68 - "Research: Call Site Dispatch"
Cohesion: 0.09
Nodes (46): accumulate(), accumulateAdditive(), applyAxisAngle(), applyQuaternion(), Bb(), center(), compose(), decompose() (+38 more)
...
Cohesion: 0.04
Nodes (75): alarmMaterial(), facadeMaterial(), Facades, FacadeUniforms, along(), approach(), easeInOut(), route() (+67 more)
...
Cohesion: 0.04
Nodes (75): resolve(), fromCaller(), churnAt(), ChurnEvent, ChurnFile, notShallow(), parseLog(), args (+67 more)
...
Cohesion: 0.15
Nodes (14): analyseAt(), art(), ART_USAGE, ArtIo, ArtOptions, datasets(), DEFAULT_IO, parseArt() (+6 more)
...
Cohesion: 0.07
Nodes (42): aj(), cJ(), clampLength(), computeMovement(), coplanarPoint(), divideScalar(), dJ(), eK() (+34 more)
...
Cohesion: 0.09
Nodes (38): Ab(), arc(), bg(), bz(), Cb(), Db(), Fb(), fill() (+30 more)
...
Cohesion: 0.06
Nodes (31): devDependencies, leva, react, react-dom, @react-three/drei, @react-three/fiber, @react-three/postprocessing, @tanstack/react-hotkeys (+23 more)
...
Cohesion: 0.08
Nodes (47): Atlas, FileHealth, FileScore, ROLES, SymbolNames, Timeline, deadRows(), healthRows() (+39 more)
...
Cohesion: 0.10
Nodes (36): addScaledSH(), addScaledVector(), angleTo(), clampScalar(), closestPointToPoint(), closestPointToPointParameter(), computeFrenetFrames(), cross() (+28 more)
...
Cohesion: 0.10
Nodes (35): applyMatrix3(), applyMatrix4(), applyNormalMatrix(), ck(), _computeIntersections(), computeVertexNormals(), fromBufferAttribute(), fromHalfFloat() (+27 more)

### Community 101 - "Research: Tree-sitter/AST"
Cohesion: 0.08
Nodes (55): AXIS_VALUES, checkClaim(), Checked, cloudedBy(), countClaim(), decide(), durable(), existsClaim() (+47 more)

### Community 102 - "Community 102"
Cohesion: 0.10
Nodes (34): _applyTexData(), bindLightTargets(), bindSkeletons(), createDataTexture(), CY(), extractUrlBase(), fromJSON(), getObjectById() (+26 more)

### Community 103 - "Community 103"
Cohesion: 0.40
Nodes (4): The city (archived), Under the health lens, What the city drew, When a search finds one file
...
Cohesion: 0.09
Nodes (24): addLevel(), bezierCurveTo(), clone(), copy(), EA(), fromEquirectangularTexture(), getHex(), getHexString() (+16 more)

### Community 107 - "Bench: Cached Judgement & Cached Replicates"
Cohesion: 0.07
Nodes (39): fixture, flagsIn(), derivedDraftPath(), segment(), writeDraft(), answered(), batches(), diagnosed() (+31 more)
...
Cohesion: 0.17
Nodes (24): addScalar(), addVectors(), computeBoundingBox(), computeBoundingSphere(), depth(), expandByObject(), expandByPoint(), expandByScalar() (+16 more)
...
Cohesion: 0.09
Nodes (24): applyEuler(), conjugate(), makeRotationX(), makeRotationY(), makeRotationZ(), _onChangeCallback(), order(), reorder() (+16 more)

### Community 140 - "Bench: Difficulty & Levels"
Cohesion: 0.12
Nodes (24): clamp(), clampPoint(), computeLineDistances(), containsPoint(), distance(), distanceSq(), distanceTo(), distanceToPlane() (+16 more)

### Community 141 - "Bench: What & Counts"
Cohesion: 0.13
Nodes (14): at, lightFrom(), starLitMaterial(), fadeAll(), Anchor, Nearby, NearSystem(), place() (+6 more)
...
Cohesion: 0.19
Nodes (14): determinantAffine(), extractBasis(), extractRotation(), fromArray(), identity(), ik(), length(), setFromMatrix3Column() (+6 more)
...
Cohesion: 0.26
Nodes (13): addGeometry(), addUpdateRange(), applyBoneTransform(), bj(), computeTangents(), getAttribute(), getComponent(), getIndex() (+5 more)
...
Cohesion: 0.24
Nodes (14): between(), drawMeteors(), drawSatellite(), drawSky(), makeSky(), Meteor, paintDust(), paintGrain() (+6 more)
...
Cohesion: 0.08
Nodes (45): callEdgesOf(), callClaim(), Candidate, claimsFor(), over(), PREDICATES, referenceClaim(), bodyOf() (+37 more)
...
Cohesion: 0.06
Nodes (32): Analysis honesty, Classification, codedocs, Documentation, Language, Observing the repository, The index on disk, The internal representation (+24 more)
...
## Knowledge Gaps
- **1062 isolated node(s):** `$schema`, `baseBranch`, `access`, `format`, `changelog` (+1057 more)
...
- **Why does `#_()` connect `CLI Render Notes` to `Operation Reports & Envelopes`, `CLI Draft & Stack Traces`, `Cold-Start Project Indexing`, `Evidence & Reference Resolution`, `Community 139`, `Bench: Difficulty & Levels`, `CLI Help & Codedocs Answers`, `Community 144`, `Community 154`, `Bench Writeup Comparisons`, `Community 157`, `Community 44`, `Docs: Domain Documentation Conventions`, `ADR/CONTEXT: SymbolId Types`, `CLI Test Fixtures (Draft)`, `Community 193`, `Community 67`, `Research: Call Site Dispatch`, `Community 84`, `Community 88`, `Community 98`, `Community 99`, `Bench: No-Tools Judging Scale`, `Community 102`, `Community 106`, `Community 117`?**
