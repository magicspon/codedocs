...
## Corpus Check
- 503 files · ~391,740 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3581 nodes · 8630 edges · 217 communities (183 shown, 34 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 129 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `91f6fde3`
...
## Communities (217 total, 34 thin omitted)
...
Cohesion: 0.10
Nodes (39): DocumentFault, Claim, ClaimSyntaxError, countClaim(), CountPredicate, COUNTS, fail(), labelClaim() (+31 more)

### Community 2 - "Preflight Fingerprinting"
Cohesion: 0.12
Nodes (36): BLOCKS, declaredDependencies(), installedPackage(), canonical(), fingerprintOf(), asRecord(), asStrings(), endOfString() (+28 more)

### Community 3 - "Config Classification & Errors"
Cohesion: 0.13
Nodes (35): ConfigError, ConfigRefusal, invalid(), misplacedConfig(), blank(), blankComments(), blankTrailingCommas(), endOfString() (+27 more)

### Community 4 - "CLI Render Notes"
Cohesion: 0.12
Nodes (27): Atlas, Timeline, lampOf(), embedded(), Load, loaders, loadSeries(), sources() (+19 more)
...
Cohesion: 0.16
Nodes (26): requestedCommit(), byAncestry(), byNewest(), capture, directoryFor(), evict(), listBaselines(), message() (+18 more)

### Community 7 - "Operation Reports & Envelopes"
Cohesion: 0.06
Nodes (76): Scope, Scoping, unfiltered(), AnalysisTotals, BaselineRequest, ProjectSummary, add(), assemble() (+68 more)

### Community 8 - "CLI Draft & Stack Traces"
Cohesion: 0.11
Nodes (29): effective(), EffectiveLabels, rank(), configured(), labelFiles(), LabelPass, labelsFor(), matches() (+21 more)

### Community 9 - "Cold-Start Project Indexing"
Cohesion: 0.06
Nodes (65): analyse(), installFor(), resolve(), DraftSection, Reproduction, fixture, flagsIn(), derivedDraftPath() (+57 more)
...
Cohesion: 0.14
Nodes (25): preflightProjects(), extractProject(), rebuild(), projectRow(), stamp(), currentCommit(), discoverProjects(), expandProjectGlobs() (+17 more)

### Community 12 - "Core Test Fixtures & Symbols"
Cohesion: 0.04
Nodes (79): DocumentReport, SectionReport, Verdict, DEFAULT_SCOPE, DocsOptions, DoctorEnvelope, ambiguityNote(), ambiguityNoteFor() (+71 more)

### Community 13 - "CLI Args & Messages"
Cohesion: 0.08
Nodes (37): configSentence(), parseFilter(), scopeOf(), checkFlags(), Command, FAIL_ON, failed(), Invocation (+29 more)
...
Cohesion: 0.06
Nodes (59): symbolCount(), cityLayout, LAMP, litOf(), facadeMaterial(), Facades, FacadeUniforms, armKeys() (+51 more)

### Community 17 - "Docs Draft Facts Assembly"
Cohesion: 0.07
Nodes (56): applyScope(), UNSCOPED, callEdgesOf(), callees(), callers(), collect(), assemble(), draft() (+48 more)
...
Cohesion: 0.11
Nodes (24): Nine edge kinds, closed enum, Three bindings, one to one with the operation set, Arm (toolset@model), baseline arm, codedocs arm, codedocs, fallow, Caller attribution (+16 more)
...
Cohesion: 0.07
Nodes (32): walk(), namingFor(), CLASS_OF_KIND, coarseClassOf(), descriptor, fileOf(), isSymbolId(), PackageRef (+24 more)
...
Cohesion: 0.07
Nodes (47): FileDatum, Link, detailFile(), hoveredFile(), rowAt(), cursorFile(), firstCursor(), Move (+39 more)
...
Cohesion: 0.13
Nodes (30): Config, ProjectPreflight, ProjectSlice, anythingOutstanding(), memoise(), movedProjects(), openSession(), Outstanding (+22 more)
...
Cohesion: 0.11
Nodes (30): DATASETS, embedded(), Load, loaders, loadNames(), sources(), Playhead, Series (+22 more)
...
Cohesion: 0.17
Nodes (29): checkSection(), AXIS_VALUES, checkClaim(), Checked, cloudedBy(), countClaim(), decide(), durable() (+21 more)

### Community 37 - "Effective Labels Configuration"
Cohesion: 0.20
Nodes (20): group(), openFor(), reanalyse(), repairWave(), runWave(), seedFrontier(), touchedProjects(), readBrokenImporters() (+12 more)
...
Cohesion: 0.19
Nodes (19): DEFAULTS, labelsOf(), PRECEDENCE, valueOf(), AXIS_VALUES, excludedBy(), LabelFilter, Disagreement (+11 more)
...
Cohesion: 0.24
Nodes (7): buildTree(), Dir, Item, Layout, squarify(), treemap(), worst()
...
Cohesion: 0.21
Nodes (17): CallSource, Naming, ATTRIBUTIONS, DERIVATIONS, named(), PROVENANCES, byEndpoints(), EdgeRow (+9 more)

### Community 46 - "GitHub Workflows & Renovate"
Cohesion: 0.15
Nodes (17): Single-Context Repo Layout, fallow, Fallow Exit Code Convention, cspell project word list, Project Spelling Dictionary, pnpm Workspace Configuration, Example Apps Consume Packages By Link, Minimum Release Age Policy (+9 more)

### Community 47 - "README: Edge Kinds"
Cohesion: 0.21
Nodes (21): CAUSES, code(), FIDELITIES, LABEL_AXES, LABEL_VALUES, REFERENCE_KINDS, internerFor(), writeCallEdges() (+13 more)
...
Cohesion: 0.09
Nodes (22): Code Comment Conventions, Architecture Decision Records, Before exploring, read these, CONTEXT.md Glossary, Domain Docs, File structure, Flag ADR conflicts, Lazy Domain Doc Creation (+14 more)
...
Cohesion: 0.12
Nodes (20): Changeset: first published release, First published release of @codedocs/cli, Five node types, Consequences, Considered Options, Symbol identity is a normalised SCIP string, scoped to one snapshot, The edge kinds, The node types (+12 more)

### Community 60 - "ADR/CONTEXT: Label Axes"
Cohesion: 0.33
Nodes (11): Closed predicate set for claims, Edge, Evidence, Candidate, Claim, Claim coverage, Document, Verdict (+3 more)
...
Cohesion: 0.22
Nodes (15): Candidate, checkDocument(), ClaimReport, LinkReport, pathsIn(), reportLink(), resolveRelative(), scopeFromText() (+7 more)

### Community 68 - "Research: Call Site Dispatch"
Cohesion: 0.07
Nodes (42): alarmMaterial(), FlowShape, focusTexture(), PointCloud, Life, visibility(), CLEAR, Sky (+34 more)
...
Cohesion: 0.09
Nodes (24): SymbolNames, args, atlas, [given, nameArg], out, outDir, root, target (+16 more)
...
Cohesion: 0.07
Nodes (28): devDependencies, leva, react, react-dom, @react-three/drei, @react-three/fiber, @react-three/postprocessing, @tanstack/react-hotkeys (+20 more)
...
Cohesion: 0.10
Nodes (32): grabbed(), pilot(), plan(), toward, travel(), Trip, clamp(), Craft (+24 more)
...
Cohesion: 0.29
Nodes (14): FileNode, ImportEdge, SpecifierSite, SymbolId, SymbolNode, UnresolvedCall, UnresolvedSpecifier, CalleeStep (+6 more)

### Community 102 - "Community 102"
Cohesion: 0.17
Nodes (19): Glimpse, Planet, Ring, at, dummy, Glimpses(), MoonsFor, CIRCLE (+11 more)

### Community 103 - "Community 103"
Cohesion: 0.22
Nodes (13): byEvidence(), Continuation, continuationOf(), derivationsFor(), directoryOf(), merge(), MovedFile, namedInHead() (+5 more)
...
Cohesion: 0.18
Nodes (13): extend(), filesOf(), finish(), PathTerminus, tailOf(), terminusOf(), trace(), TracePath (+5 more)

### Community 108 - "Community 108"
Cohesion: 0.12
Nodes (32): CheckContext, FilePath, ProjectNode, dottedOf(), KINDS, PRECONDITION_CAUSES, IndexHeader, writeMeta() (+24 more)
...
Cohesion: 0.15
Nodes (15): linksOf(), SymbolLink, Drawn, drawnIn(), farEnd(), MoonLink, moonLinksOf(), Place (+7 more)
...
Cohesion: 0.24
Nodes (11): along(), approach(), easeInOut(), route(), Shot, Controls, Leg, snapshot() (+3 more)
...
Cohesion: 0.23
Nodes (13): Consequences, Considered Options, Preconditions lower fidelity; honesty is evidence, not a score, Four generic preflight signals, Configuration, Analysis conditions, Environment fingerprint, Fidelity (+5 more)
...
Cohesion: 0.14
Nodes (22): FileSymbols, KINDS, glimpsesOf(), moonsOf(), orbitsOf(), ringsOf(), SIZES, systemsAlong() (+14 more)

### Community 157 - "Community 157"
Cohesion: 0.20
Nodes (11): at, lightFrom(), starLitMaterial(), fadeAll(), Anchor, Nearby(), NearSystem(), place() (+3 more)
...
Cohesion: 0.13
Nodes (22): Commit, FallowMeta, FileHealth, FileScore, ROLES, frameSummary, deadRows(), healthRows() (+14 more)
...
Cohesion: 0.29
Nodes (12): Three channels of honesty that must not blur, Report, Blind spot, codedocs.jsonc configuration, Envelope, Report (report-bug artefact), Scope, Truncation (+4 more)
...
Cohesion: 0.12
Nodes (25): BaselineChoice, chooseBaseline(), openBaseline(), StoredBaseline, Change, changedFiles(), fidelities(), fromGit() (+17 more)
...
Cohesion: 0.08
Nodes (26): Analysis honesty, Classification, codedocs, Documentation, Language, Observing the repository, The index on disk, The internal representation (+18 more)

### Community 198 - "Community 198"
Cohesion: 0.24
Nodes (9): DEFAULT_EXCLUDES, globbedFiles(), outputDirectories(), Lookups, ProjectConfig, toRepoPath(), config(), globbed() (+1 more)
...
## Knowledge Gaps
- **1022 isolated node(s):** `$schema`, `baseBranch`, `access`, `format`, `changelog` (+1017 more)
...
- **Why does `resolve()` connect `Cold-Start Project Indexing` to `TS7 Adapter Symbol Resolution`, `Preflight Fingerprinting`, `Config Classification & Errors`, `Operation Reports & Envelopes`, `Docs: Local Static Analysis Layer`, `Community 73`, `README Overview`, `Bench Judge Grading`?**
