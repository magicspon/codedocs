...
import { armsIn, readRecord } from '../core/arms.ts'
import { has } from '../core/argv.ts'
import { casesById, loadProspects } from '../cases/cases.ts'
import {
  type Comparison,
  comparisonsIn,
  questionOf,
  runsOf,
} from '../reporting/comparisons.ts'
import { LEVELS } from '../cases/difficulty.ts'
import { heading, sections } from '../reporting/markdown.ts'
import { BENCH, RESULTS } from '../core/paths.ts'
import {
  colophon,
  type Coverage,
  howToRead,
